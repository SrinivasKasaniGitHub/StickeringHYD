		...
		ok_dialog.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (last_chasisNo_input.getText().toString().trim() != null
					...
					last_chasisNo_input.setError(Html.fromHtml("<font color='black'>Please Enter Last Five Digits of Chasis No</font>"));
				} else {
					...
					if (match_chasis.equals(SpotChallan.fake_veh_chasisNo)) {
						...
						AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
								Fake_NO_Dialog.this, AlertDialog.THEME_HOLO_LIGHT);
					...
					else if (!match_chasis.equals(SpotChallan.fake_veh_chasisNo)) {
						Log.i("*******match_chasis******", match_chasis);
						// TODO Auto-generated method stub
					...
					} else if (!match_chasis.equals(Drunk_Drive.fake_veh_chasisNo)) {// vinay_code
