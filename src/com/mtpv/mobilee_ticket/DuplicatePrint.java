...
public class DuplicatePrint extends Activity implements OnClickListener {
	...
	String[] report_type_arr = { day_report, officer_perfmnce, wheeler_based,
			violation_based };
		...
		try {
			...
			if (c.getCount() == 0) {
				...
				while (c.moveToNext()) {
					...
					Log.i("Duplicate Records print_apptype",""+ c.getString(c.getColumnIndex(DBHelper.dup_print_app_type)));
						...
						if (bluetoothAdapter == null) {
							...
							if (bluetoothAdapter.isEnabled()) {
								if (bluetoothAdapter.isDiscovering()) {
									...
									if (Dashboard.check_vhleHistory_or_Spot.equals("reports")) {
										if ((Dashboard.check_vhleHistory_or_Spot.equals("reports"))
											...
											try {
												/*String printdata = bth_printer.font_Courier_41(""+ ServiceHelper.Opdata_Chalana);
										...
										if (address.equals("btaddr")) {
											...
											if (online_report_status.equals("yes")) {
												...
												if (print_apptype.size() > 0) {
													if ((print_apptype.get(selected_type).toString().trim().equals(""+ getResources().getString(R.string.dup_drunk_drive)))
															&& (!print_respose.get(selected_type).equals(""))) {
														try {
															/*String printdata = bth_printer.font_Courier_41(""+ print_respose.get(selected_type));
															actual_printer.Call_PrintertoPrint("" + address, ""	+ printdata);*/
															
															Bluetooth_Printer_3inch_ThermalAPI printer = new Bluetooth_Printer_3inch_ThermalAPI();

											                String print_data = printer.font_Courier_41(""+ print_respose.get(selected_type));
											                actual_printer.openBT(address);
													...
													} else if ((print_apptype.get(selected_type).toString().trim().equals(""+ getResources().getString(R.string.dup_spot_challan)))
															&& (!print_respose.get(selected_type).equals(""))) {
														try {
															/*String printdata = bth_printer.font_Courier_41(""+ print_respose.get(selected_type));
															actual_printer.Call_PrintertoPrint("" + address, ""+ printdata);*/
													...
													} else if ((print_apptype.get(selected_type).toString().trim().equals(""+ getResources().getString(R.string.dup_vhcle_hstry)))
															&& (!print_respose.get(selected_type).equals(""))) {
													...
													} else if ((print_apptype.get(selected_type).toString().trim().equals(""+ getResources().getString(R.string.towing_one_line)))
															&& (!print_respose.get(selected_type).equals(""))) {
													...
													} else if ((print_apptype.get(selected_type).toString().trim().equals(""+ getResources().getString(R.string.release_documents_one_line)))
															&& (!print_respose.get(selected_type).equals(""))) {
								...
								if (address.equals("btaddr")) {
									...
									Log.i("SECOND  CASE",print_apptype.get(selected_type).toString().trim()+ ""+ getResources().getString(R.string.dup_drunk_drive));
	...
	protected Dialog onCreateDialog(int id) {
		...
		case APPTYPE_DIALOG:
			...
			ad_app_type.setSingleChoiceItems(
					print_apptype.toArray(new String[print_apptype.size()]),
					selected_type, new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							if ((print_apptype.get(which).toString().trim().equals(""+ getResources().getString(R.string.dup_drunk_drive)))
									&& (!print_respose.get(which).equals(""))) {
								tv_dp_text.setText(""+ print_respose.get(which));
							} else if ((print_apptype.get(which).toString().trim().equals(""+ getResources().getString(R.string.dup_spot_challan)))
									&& (!print_respose.get(which).equals(""))) {
								tv_dp_text.setText(""+ print_respose.get(which));

							} else if ((print_apptype.get(which).toString().trim().equals(""+ getResources().getString(R.string.dup_vhcle_hstry)))
									&& (!print_respose.get(which).equals(""))) {
								tv_dp_text.setText(""+ print_respose.get(which));
								} else if ((print_apptype.get(which).toString().trim().equals(""+ getResources().getString(R.string.towing_one_line)))
									&& (!print_respose.get(which).equals(""))) {
								tv_dp_text.setText(""+ print_respose.get(which));
								
							} else if ((print_apptype.get(which).toString().trim().equals(""+ getResources().getString(R.string.release_documents_one_line)))
									&& (!print_respose.get(which).equals(""))) {
								tv_dp_text.setText(""+ print_respose.get(which));
	...
	DatePickerDialog.OnDateSetListener md1 = new DatePickerDialog.OnDateSetListener() {
		...
		public void onDateSet(DatePicker view, int selectedYear,
			...
			if (Dashboard.check_vhleHistory_or_Spot.equals("reports")) {
				...
				btn_dp_date_selection.setText(""
						+ present_date_toSend.toUpperCase());
			}
	...
	public class Async_reports extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			// TODO Auto-generated method stub
			getSimImeiNo();
			SharedPreferences sharedPreference2 = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
			...
			ServiceHelper.getDayReports("" + Dashboard.UNIT_CODE, ""
					+ pidCd, ""
					+ pidName, ""
					+ present_date_toSend, "" + simid_send, "" + imei_send, ""
					+ report_id_send);
			return null;
		}
	...
	public class Async_getOnlineDuplicatePrint extends
		...
		protected String doInBackground(Void... params) {
			...
			ServiceHelper.getOnlineDuplicatePrint("" + Dashboard.UNIT_CODE, ""
					+ pidCd, ""
					+ pidName, ""
					+ et_dp_regno.getText().toString().trim().toUpperCase(), ""
					+ present_date_toSend, "" + simid_send, "" + imei_send);
