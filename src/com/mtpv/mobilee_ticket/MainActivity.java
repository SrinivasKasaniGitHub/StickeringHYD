...
public class MainActivity extends Activity implements OnClickListener,
	...
	public static String Pid_code = "", Pid_pswrd = "", Pid_Name = "",
			Ps_code = "", Ps_Name = "", CADRE_CODE = "", CADRE_NAME = "",
			UNIT_CODE = "", UNIT_NAME = "", SECURITY_CD = "";
	...
	public static String e_user_tmp = "", e_imei = null, e_latitude = null,
			e_longitude = "";
	/* GPS VALUES */
	// flag for GPS status
...
//		et_pid_pwd.setText("WdSt24Pr");
		...
		/*et_pid.setText("2300189125");
		et_pid_pwd.setText("1977");*/
	...
	public class Async_task_login extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			ServiceHelper.login("" + user_id, "" + e_user_tmp, "" + IMEI, ""
		...
		protected void onPostExecute(String result) {
			...
			if (ServiceHelper.Opdata_Chalana != null) {
				if (ServiceHelper.Opdata_Chalana.toString().trim().equals("1")) {
					 ...
					 * "CADRE" "CONTACT_NO" "Version"
					 * 
					 * "RTA_DATA_FLAG" "DL_DATA_FLAG" "AADHAAR_DATA_FLAG"
					 * "OTP_NO_FLAG" "CASHLESS_FLAG" "MOBILE_NO_FLAG"
					 */
	...
	public void onBackPressed() {
		...
		title.setCompoundDrawablesWithIntrinsicBounds(R.drawable.dialog_logo,
				0, R.drawable.dialog_logo, 0);
