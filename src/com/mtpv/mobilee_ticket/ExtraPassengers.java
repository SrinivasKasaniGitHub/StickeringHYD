	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ok_dialog.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				if (passngrCount_input.getText().toString().trim() == null || passngrCount_input.getText().toString().trim().length() == 0) {
					showToast("Please Enter Passengers Count");
				}else{
					SpotChallan.extraPassengers = passngrCount_input.getText().toString()!=null ? passngrCount_input.getText().toString():"1";
