...
//	}
	...
	public void onClick(View v) {
		...
		case R.id.tv_vhclehistory_dashboard_xml:
			...
			if(SpotChallan.tv_total_pending_challans!=null)
			SpotChallan.tv_total_pending_challans.setText("0");
			
			if(SpotChallan.tv_toal_amount_pending_challans!=null)
			SpotChallan.tv_toal_amount_pending_challans.setText("0");
			
			if(SpotChallan.tv_grand_total_spot!=null)
			SpotChallan.tv_grand_total_spot.setText("0");
