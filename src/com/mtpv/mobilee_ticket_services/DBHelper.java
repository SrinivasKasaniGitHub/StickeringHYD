...
public class DBHelper {
	...
	public static String wheelerCodeCreation = "create table " + wheelercode_table
			+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + wheeler_code
			+ " varchar2(20), " + wheeler_name + " varchar2(40));";

	public static String occupationCreation = "create table " + occupation_table
			+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + occuptn_code
			+ " varchar2(20), " + occuptn_name + " varchar2(40));";
	
	public static String barTableCreation = "create table " + bar_table
			+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + bar_code
			+ " varchar2(20), " + bar_name + " varchar2(40)) ";
	
	public static String termailDetailsCreation = "CREATE TABLE IF NOT EXISTS  " + TERMINAL_DETAILS_TABLE
			+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + TERMINAL_ID
			+ " varchar2(40), " + BT_NAME + " varchar2(40), " + BT_ADDRESS + " varchar2(40)) ";

	static String qualificationCreation = "create table " + qualification_table
			+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + qlfctn_code
			+ " varchar2(20), " + qlfctn_name + " varchar2(40));";

	static String vehicleCatCreation = "create table " + vehicleCat_table
			+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + vhcle_cat_code
			+ " varchar2(20), " + vhcle_cat_name + " varchar2(40));";

	static String vehicleMainCatCreation = "create table "
			+ vehicleMainCat_table
			+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , "
			+ vhcle_maincat_code + " varchar2(20), " + vhcle_maincat_name
			+ " varchar2(40));";
	...
	public static String violatioPointsDetaisCreation = "create table " + violationPointsTable
			+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + offenceCode
			+ " varchar2(20), " + wheelerCode + " varchar2(20), " + penalityPoints + " varchar2(20));";
	
	static String duplicatePrintCreation = "create table "
			+ duplicatePrint_table
			+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + dup_print_respnse
			+ " varchar2(5000), " + dup_print_app_type + " varchar2(30));";

	/* VIOLATION CODE */
	static String violationsCreation = "create table " + vioalation_table
			+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + vltn_wheeler_code
			+ " varchar2(20), " + vltn_offence_code + " varchar2(10), "
			+ vltn_section + " varchar2(40), " + vltn_violation_desc
			+ " varchar2(50), " + vltn_min_fine + " varchar2(40), "
			+ vltn_max_fine + " varchar2(40));";
	...
	public DBHelper(Context context) {
	 ...
	 public static final String CREATE_USER_TABLE ="CREATE TABLE IF NOT EXISTS " + USER_TABLE
		+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + PIDCODE + " varchar2(30), " + PASSWORD + " varchar2(10), " + PIDNAME + " varchar(30),"
				+ PID_NAME + " varchar2(30), "+ PS_CODE + " varchar2(30),"+ PS_NAME + " varchar2(30), "+ CADRE_CODE + " varchar2(30),"
						+ CADRE_NAME + " varchar2(30), " + UNIT_CODE + " varchar2(30),  " + UNIT_NAME + " varchar2(30));";
	 ...
	 public static final String CREATE_PINPAD_TABLE ="CREATE TABLE IF NOT EXISTS " + PINPAD_TABLE
				+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + PINPAD_ID + " varchar2(30), " + PINPAD_NAME + " varchar2(30));";
	 ...
	 public static final String CREATE_BT_PRINTER ="CREATE TABLE IF NOT EXISTS " + BT_PRINTER_TABLE
				+ " ( SNO INTEGER PRIMARY KEY AUTOINCREMENT , " + PRINTER_ADDRESS + " varchar2(30), " + PRINTER_NAME + " varchar2(30));";
	...
	public static void insertBarDetails(String barCode, String barName) {
		...
		//Log.i("Bar Table ::::::", ""+DBHelper.bar_table.trim().toUpperCase());
	...
	public static void insertVehicleMainCatDetails(String vmain_code,
			String vmainc_name) {
		ContentValues con = new ContentValues();
	...
	/*public static void insertOccupationDetails(String occup_code, String occup_desc) {
		ContentValues con = new ContentValues();
		con.put(occupation_name, occup_code);
		con.put(occupation_desc, occup_desc);
		db.insert(occupation_table, null, con);
	}*/

	public static void insertDuplicatePrintDetails(String dup_res,
			String app_type) {
		ContentValues con = new ContentValues();
	...
	public static void insertViolationDetails(String whlr_code,
			String ofnce_cde, String sec, String vltn_desc, String min_fine,
			String mx_fine) {
		ContentValues con = new ContentValues();
